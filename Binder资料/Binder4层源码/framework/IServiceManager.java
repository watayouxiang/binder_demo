...
public interface IServiceManager extends IInterface
{
     ...
     */
    public android.os.IBinder getService(String name) throws RemoteException;
    
    /**
     * Retrieve an existing service called @a name from the
     * service manager.  Non-blocking.
     */
    public android.os.IBinder checkService(String name) throws RemoteException;

    /**
     * Place a new @a service called @a name into the service
     * manager.
     */
    public void addService(String name, android.os.IBinder service, boolean allowIsolated)
